...
System.bundles = {"bundles/bit-docs-site/static.css!":["bit-docs-html-canjs@0.4.4#static/canjs.less!$less","bit-docs-prettify@0.1.0#prettify.less!$less","bit-docs-site@0.0.1#styles/styles.less!$less"]};
/*npm-utils*/
...
define('package.json!npm', [
    ...
    (function (loader, packages, options) {
        ...
        },
        {
            ...
            'globalBrowser': {},
            'browser': {},
            'resolutions': { 'bit-docs-html-canjs': '0.4.4' }
        },
        {
...
/*bit-docs-html-canjs@0.4.4#static/canjs*/
define('bit-docs-html-canjs@0.4.4#static/canjs', function (require, exports, module) {
    require('./canjs.less!');
    $ = require('jquery');
    var $articleContainer, $onThisPage, $tableOfContents, $onThisPageTitle, $everything, $headers, $nav, headerHidden, animating, navigating;
    setState();
